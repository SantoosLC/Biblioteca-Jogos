                        ...
                        <div class="p-5">
                            ...
                            <form class="user">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="password" class="form-control form-control-user" name="confirmar-senha" placeholder="Confirmar Senha" required>
                                    </div>
                                </div>
                                ...
                                <a href="index.html" class="btn btn-google btn-user btn-block">
                                    <i class="bi bi-google"></i> Registrar com Google
                                </a>

                                <a href="index.html" class="btn btn-github btn-user btn-block">
                                    <i class="bi bi-github"></i> Registrar com Github
                                </a>
                            </form>
